...
The experiment will use a computer application (see the image below). To start playback, press one of the Play buttons. To stop the sound, use the Stop or Pause button.  
...
![Labeled interface](images/label.gif)
...
![Labeled scale](images/scale_label.png)
