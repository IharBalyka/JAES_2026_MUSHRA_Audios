...
## Warunki udziału i polityka prywatności
...
W eksperymencie wykorzystana zostanie aplikacja komputerowa (obraz poniżej). Aby rozpocząć odtwarzanie dźwięku, należy nacisnąć jeden z przycisków Play. Do wyłączenia dźwięku służy przycisk Stop lub Pauza.  
...
![Interfejs z etykietami](images/label.gif)
...
![Skala z etykietami](images/scale_label.png)
...
Na każdej stronie testowej wyświetlano pytanie:
